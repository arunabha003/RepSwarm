...
contract ERC8004IntegrationTest is Test {
    ...
    function test_sepoliaAddresses() public pure {
        assertEq(ERC8004Integration.SEPOLIA_IDENTITY_REGISTRY, 0x8004A818BFB912233c491871b3d84c89A494BD9e);
        assertEq(ERC8004Integration.SEPOLIA_REPUTATION_REGISTRY, 0x8004B663056A597Dffe9eCcC1965A193B7388713);
    }

    function test_mainnetAddresses() public pure {
        assertEq(ERC8004Integration.MAINNET_IDENTITY_REGISTRY, 0x8004A169FB4a3325136EB29fA0ceB6D2e539a432);
        assertEq(ERC8004Integration.MAINNET_REPUTATION_REGISTRY, 0x8004BAa17C55a88189AE136b182e5fdA19dE9b63);
    }
    ...
    function test_tags() public pure {
        assertEq(keccak256(bytes(ERC8004Integration.TAG_SWARM_ROUTING)), keccak256(bytes("swarm-routing")));
        assertEq(keccak256(bytes(ERC8004Integration.TAG_MEV_PROTECTION)), keccak256(bytes("mev-protection")));
    }
